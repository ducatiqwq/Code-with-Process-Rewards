...
export MODEL_PATH=".checkpoints/deepcoder/1.5b-4k-grpo+-code/actor/global_step_25"
...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=./data/baseline_train.json \
    ...
    trainer.experiment_name='1.5b-4k-grpo+-code' \
